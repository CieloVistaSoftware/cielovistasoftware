...
export function insertSnippet(snippet) {
  ...
  const snippets = {
    ...
    hero: '<section class="hero" style="background: linear-gradient(135deg, var(--primary, #667eea), var(--secondary, #764ba2)); color: var(--text, white); padding: 100px 20px; text-align: center;">\n  <h1 style="color: var(--heading, white); font-size: 3rem; margin-bottom: 1rem; font-weight: bold;">Welcome to My Site</h1>\n  <p style="font-size: 1.5rem; margin-bottom: 2rem; opacity: 0.9;">Subtitle goes here</p>\n  <button style="background: var(--accent, white); color: var(--bg, #333); padding: 15px 40px; border: none; border-radius: 5px; font-size: 1.1rem; cursor: pointer; font-weight: bold;">Call to Action</button>\n</section>',
    footer: '<footer style="background: var(--bg, #333); color: var(--text, white); padding: 40px 20px; text-align: center;">\n  <p>&copy; 2025 Your Name. All rights reserved.</p>\n  <div class="social" style="margin-top: 20px;">\n    <a href="#" style="color: var(--primary, #667eea); margin: 0 10px; text-decoration: none;">Facebook</a>\n    <a href="#" style="color: var(--primary, #667eea); margin: 0 10px; text-decoration: none;">Twitter</a>\n    <a href="#" style="color: var(--primary, #667eea); margin: 0 10px; text-decoration: none;">Instagram</a>\n  </div>\n</footer>',
    form: '<form style="max-width: 500px; margin: 0 auto; padding: 20px;">\n  <input type="text" placeholder="Name" required style="width: 100%; padding: 12px; margin-bottom: 15px; border: 2px solid var(--border, #ddd); border-radius: 5px; font-size: 1rem;">\n  <input type="email" placeholder="Email" required style="width: 100%; padding: 12px; margin-bottom: 15px; border: 2px solid var(--border, #ddd); border-radius: 5px; font-size: 1rem;">\n  <textarea placeholder="Message" required style="width: 100%; padding: 12px; margin-bottom: 15px; border: 2px solid var(--border, #ddd); border-radius: 5px; font-size: 1rem; min-height: 120px;"></textarea>\n  <button type="submit" style="background: var(--primary, #667eea); color: white; padding: 12px 30px; border: none; border-radius: 5px; font-size: 1rem; cursor: pointer; font-weight: bold;">Send</button>\n</form>',
    card: '<div class="card" style="background: var(--bg, white); border: 1px solid var(--border, #ddd); border-radius: 8px; padding: 20px; max-width: 300px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">\n  <img src="https://placehold.co/300" alt="Card image" style="width: 100%; border-radius: 5px; margin-bottom: 15px;">\n  <h3 style="color: var(--heading, #333); margin-bottom: 10px;">Card Title</h3>\n  <p style="color: var(--secondary, #666); margin-bottom: 15px;">Card description goes here</p>\n  <button style="background: var(--primary, #667eea); color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">Learn More</button>\n</div>'
  };
